package rs.ac.bg.etf.js150411d.shapes;

import javafx.scene.shape.MeshView;
import javafx.scene.shape.TriangleMesh;

public class DiskMesh extends MeshView {
    ...
    public DiskMesh(double innerRadius, double outerRadius, float hegiht, int divs) {
    ...
    public DiskMesh(double innerRadius, double outerRadius, float height) {
